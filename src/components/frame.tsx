...
export function CardInformation({ children }: { children: ReactNode }) {
  return (
    <dl className="max-lg:bg-Surface max-lg:rounded-lg max-lg:px-4 max-lg:pt-4 max-lg:pb-2  flex flex-col col-span-9 xs:col-span-7 sm:col-span-6 md:col-span-4 lg:col-span-5 snap-start max-lg:light-shadow">
      {children}
    </dl>
  );
}
