...
const container = tv({
  slots: {
    ...
    colorTextSing:
      "relative -left-3 -top-6 z-10 w-56 -rotate-3 rounded-xl bg-blue-400 px-1 pb-1 text-center font-sans text-xs font-bold drop-shadow-lg",
  },
  variants: {
    model: {
      notFound: {
...
export default function ErrorPage<T extends ElementType = "div">({
  ...
  return (
    ...
    >
      <HTitle containerAs="header" as="h1" className="text-base-accent">
        {textH1}
      </HTitle>
      <div className="blockContainer-px blockContainer-pb flex w-full flex-1 flex-col items-center justify-between">
        ...
        <div className="all-gap z-10 flex min-h-min w-full flex-col items-center">
          <p className="text-center font-sans text-2xl font-black text-base-body">
            Oops!
          </p>
          <p className="text-center font-sans text-base font-black text-base-body">
            {textMsg1}
            <br />
            {textMsg2}
          </p>
