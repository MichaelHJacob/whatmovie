...
const searchStyles = tv({
  ...
  slots: {
    labelSearch:
      "group/label w-full cursor-pointer items-center gap-2 p-1 text-placeholder outline-2 outline-offset-1 outline-transparent transition-all duration-200 has-[:focus]:outline-input-focus",
    inputSearch:
