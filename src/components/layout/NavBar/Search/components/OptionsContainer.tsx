...
const OptionsContainerStyles = tv({
  ...
  variants: {
    active: {
      true: {
        divContainer:
          "max-lg:blockContainer-px shadow-light box-content h-screen w-screen max-w-md bg-floating-expanded backdrop-blur-xl max-sm:w-screen lg:px-[--pMD] xl:pr-[calc((100vw-1280px)/2+var(--pMD))]",
      },
      false: {
