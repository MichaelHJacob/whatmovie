...
export const metadata: Metadata = {
  title: "WhatMovie | O filme para sua escolha certa!",
  description:
    "Encontre o filme ideal para hoje no WhatMovie. Curadoria de filmes, detalhes e avaliações para facilitar sua escolha.",
